...
local notificationFont = dxCreateFont('ust_yazi/roboto.ttf', 12 * 2, false);
local iconsFont = dxCreateFont('ust_yazi/icons.ttf', 12 * 2, false);
...
addEventHandler('onClientRender', root,
    function()
        for k, v in pairs(notificationData) do
            ...
            roundedRectangle(v.CurrentX, 60, 25 + v.CurrentWidth, 25, tocolor(0, 0, 0, 150 * v.Alpha / 255), _, true);
            dxDrawRectangle(v.CurrentX, 60, 25, 25, tocolor(0, 0, 0, 255 * v.Alpha / 255), true);
            
            if (v.Alpha == 255) then
                dxDrawText(v.Text, v.CurrentX + 25 + 10, 50, v.CurrentX + 25 + 10 + v.CurrentWidth - 20, 70 + 25, tocolor(255, 255, 255, 255), 0.40, notificationFont, 'center', 'center', true, false, true);
            end
            
            if (v.Type == 'error') then
                dxDrawText('', v.CurrentX + 5, 60, v.CurrentX + 5 + 25 - 10, 60 + 25, tocolor(215, 90, 90, v.Alpha), 0.50, iconsFont, 'center', 'center', false, false, true);
            elseif (v.Type == 'warning') then
                dxDrawText('', v.CurrentX + 5, 60, v.CurrentX + 5 + 25 - 10, 60 + 25, tocolor(220, 180, 80, v.Alpha), 0.50, iconsFont, 'center', 'center', false, false, true);
            elseif (v.Type == 'info') then
                dxDrawText('', v.CurrentX + 5, 60, v.CurrentX + 5 + 25 - 10, 60 + 25, tocolor(85, 180, 245, v.Alpha), 0.50, iconsFont, 'center', 'center', false, false, true);
            elseif (v.Type == 'success') then
                dxDrawText('', v.CurrentX + 5, 60, v.CurrentX + 5 + 25 - 10, 60 + 25, tocolor(80, 205, 105, v.Alpha), 0.50, iconsFont, 'center', 'center', false, false, true);
            end
        end
    end
)
...
addEventHandler('mesaj', root, mesaj);
